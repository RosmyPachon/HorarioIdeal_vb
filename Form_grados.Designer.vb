...
Partial Class Form_grados
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_grados))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Panel2.Location = New Point(167, 6)
        Panel2.Name = "Panel2"
