...
Partial Class Form_roles
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_roles))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Contenedor.Location = New Point(305, 111)
        Contenedor.Name = "Contenedor"
        Contenedor.Size = New Size(613, 271)
        Contenedor.TabIndex = 35
        ' 
        ' Usuarios
        ' 
