...
Partial Class Form_horarios
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_horarios))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Label1.Location = New Point(299, 157)
        Label1.Name = "Label1"
