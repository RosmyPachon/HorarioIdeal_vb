...
Partial Class Form_Aulas
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_Aulas))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Label2.TabIndex = 1
        Label2.Text = "Administrar Aulas"
        ' 
        ' Contenedor
        ' 
        Contenedor.BackColor = Color.White
        Contenedor.Controls.Add(Usuarios)
        Contenedor.Location = New Point(304, 113)
        ...
        Label1.Location = New Point(298, 157)
        Label1.Name = "Label1"
