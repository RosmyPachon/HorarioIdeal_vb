...
Partial Class Form_estudiantes
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_estudiantes))
        Panel2 = New Panel()
        Label2 = New Label()
        Panel1 = New Panel()
        ...
        Panel2.Location = New Point(165, 1)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(923, 59)
        Panel2.TabIndex = 6
        ' 
        ' Label2
        ' 
        ...
        Label2.TabIndex = 1
        Label2.Text = "Administrar Estudiantes"
        ' 
        ' Panel1
        ' 
        ...
        PictureBox3.Location = New Point(14, 151)
        ...
        roles.Location = New Point(3, 151)
        roles.Name = "roles"
        ...
        Contenedor.Location = New Point(313, 99)
        ...
        Label1.Location = New Point(307, 143)
        Label1.Name = "Label1"
        ...
        Controls.Add(Panel2)
        Controls.Add(Panel1)
        Name = "Form_estudiantes"
        Text = "Form_estudiantes"
