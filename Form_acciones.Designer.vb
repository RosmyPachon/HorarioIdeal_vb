...
Partial Class Form_acciones
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_acciones))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Panel2.Location = New Point(165, 7)
        Panel2.Name = "Panel2"
        ...
        Label2.TabIndex = 1
        Label2.Text = "Administrar Acciones"
        ' 
        ' Contenedor
        ' 
        Contenedor.BackColor = Color.White
        Contenedor.Controls.Add(Usuarios)
        Contenedor.Location = New Point(300, 99)
        ...
        Label1.Location = New Point(294, 143)
        Label1.Name = "Label1"
