...
Partial Class Form_profesores
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Form_profesores))
        Panel2 = New Panel()
        Label2 = New Label()
        ...
        Panel2.Location = New Point(166, -1)
        Panel2.Name = "Panel2"
        ...
        Label1.Location = New Point(300, 156)
        Label1.Name = "Label1"
        ...
        Controls.Add(Panel1)
        Controls.Add(Label1)
        Name = "Form_profesores"
        Text = "Form_profesores"
